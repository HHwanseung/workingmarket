...
class MemberRepositoryTest {
    ...
    public void 오류_회원가입시_아이디가_없음() throws Exception {
        //given
        Member member = Member.builder().password("123").name("Member1").nickName("nickname").role(Role.USER).age(22).build();
    ...
    public void 오류_회원가입시_이름이_없음() throws Exception {
        //given
        Member member = Member.builder().username("username").password("1233").nickName("nickname").role(Role.USER).age(22).build();
    ...
    public void 오류_회원가입시_중복된_아이디가_있음() throws Exception {
        //given
        Member member1 = Member.builder().username("username").password("123").name("member1").role(Role.USER).nickName("nickname1").age(22).build();
        Member member2 = Member.builder().username("username").password("1233").name("member2").role(Role.USER).nickName("nickname2").age(22).build();
    ...
    public void 성공_회원삭제() throws Exception {
        //given
        Member member1 = Member.builder().username("username1").password("123").name("member1").role(Role.USER).nickName("nickname1").age(22).build();
        memberRepository.save(member1);
        after();
